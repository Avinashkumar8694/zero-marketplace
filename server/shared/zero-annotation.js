  ...
  return function(target, propertyKey) {
    try {
      ...
      if (typeof propertyKey === "string") {
        try {
          isNotFunction = typeof target[propertyKey] !== "function";
        } catch (e) {
          isNotFunction = true;
        }
        if (isNotFunction) {
...
function ZeroModule(options) {
  return function(constructor) {
    ...
    if (window.ZeroRegistry) {
      window.ZeroRegistry.registerModule(options.id, constructor);
    }
  };
}
function ZeroRegistryReady() {
  return function(target, propertyKey, descriptor) {
    const originalMethod = descriptor.value;
    descriptor.value = function(...args) {
      if (window.ZeroRegistry?.isReady) {
...
var UserInterfaceType = /* @__PURE__ */ ((UserInterfaceType2) => {
  ...
  UserInterfaceType2["LAYOUT_PICKER"] = "layout-picker";
  UserInterfaceType2["RESPONSIVE_OVERRIDE"] = "responsive-override";
  UserInterfaceType2["IMAGE_PICKER"] = "image-picker";

...
(function(i) {
  (function(e) {
    var t = typeof globalThis == "object" ? globalThis : typeof Le == "object" ? Le : typeof self == "object" ? self : typeof this == "object" ? this : g(), n = o(i);
    ...
    var n = Object.prototype.hasOwnProperty, o = typeof Symbol == "function", l = o && typeof Symbol.toPrimitive < "u" ? Symbol.toPrimitive : "@@toPrimitive", u = o && typeof Symbol.iterator < "u" ? Symbol.iterator : "@@iterator", g = typeof Object.create == "function", v = { __proto__: [] } instanceof Array, b = !g && !v, A = {
    ...
    function it(r, s, a, c) {
      if (_(a)) {
        ...
        if (!M(c) && !_(c) && !z(c))
          throw new TypeError();
        return z(c) && (c = void 0), a = k(a), yt(r, s, a, c);
      }
    }
    e("decorate", it);
    function st(r, s) {
    ...
    function ot(r, s, a, c) {
      if (!M(a))
        throw new TypeError();
      return _(c) || (c = k(c)), Me(r, s, a, c);
    }
    e("defineMetadata", ot);
    function at(r, s, a) {
      if (!M(s))
        throw new TypeError();
      return _(a) || (a = k(a)), Ae(r, s, a);
    }
    e("hasMetadata", at);
    function ut(r, s, a) {
      if (!M(s))
    ...
    function lt(r, s, a) {
      if (!M(s))
        throw new TypeError();
      return _(a) || (a = k(a)), Ee(r, s, a);
    }
    e("getMetadata", lt);
    function ct(r, s, a) {
      if (!M(s))
        throw new TypeError();
      return _(a) || (a = k(a)), Se(r, s, a);
    }
    e("getOwnMetadata", ct);
    function ht(r, s) {
      if (!M(r))
        throw new TypeError();
      return _(s) || (s = k(s)), Oe(r, s);
    }
    e("getMetadataKeys", ht);
    function ft(r, s) {
      if (!M(r))
        throw new TypeError();
      return _(s) || (s = k(s)), Pe(r, s);
    }
    ...
    function ae(r, s, a) {
      ...
      return _(c) ? !1 : Te(c.OrdinaryHasOwnMetadata(r, s, a));
    }
    function Ee(r, s, a) {
      var c = ae(r, s, a);
      if (c)
      ...
      function d(p, w, E) {
        ...
        if (S !== E) {
          if (!_(S))
            return !1;
          var x = y.get(p);
          _(x) && (x = new T(), y.set(p, x)), x.set(w, E);
        }
        return !0;
      }
    }
    ...
    function At(r) {
      ...
      function c(f, d, p) {
        ...
        if (_(w)) {
          if (!p)
            return;
          w = new T(), s.set(f, w), E = !0;
        }
        var S = w.get(d);
        if (_(S)) {
          if (!p)
            return;
          if (S = new T(), w.set(d, S), !r.setProvider(f, d, a))
            throw w.delete(d), E && s.delete(f), new Error("Wrong provider for target.");
        }
        return S;
      }
      function y(f, d, p) {
    ...
    function Et(r) {
      var s = r.defineMetadata, a = r.hasOwnMetadata, c = r.getOwnMetadata, y = r.getOwnMetadataKeys, P = r.deleteMetadata, O = new N(), m = {
        ...
        function() {
          ...
          return Object.defineProperty(m.prototype, "size", {
            ...
            if (f >= 0) {
              ...
              return this._keys.length--, this._values.length--, ue(h, this._cacheKey) && (this._cacheKey = r, this._cacheIndex = -2), !0;
            }
            return !1;
...
function Ut(i) {
  return function(e) {
    class t extends e {
      ...
      _injectGlobalStyles() {
        var v;
        const l = document.querySelector('style.global-style[type="text/css"]'), u = document.querySelectorAll('link[rel="stylesheet"].global-style[type="text/css"]'), g = "adoptedStyleSheets" in Document.prototype;
        if (!this.shadowRoot) {
...
}, Be = _e ? (i) => i : (i) => i instanceof CSSStyleSheet ? ((e) => {
  let t = "";
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: Gt, defineProperty: Bt, getOwnPropertyDescriptor: Wt, getOwnPropertyNames: Ft, getOwnPropertySymbols: Vt, getPrototypeOf: qt } = Object, j = globalThis, We = j.trustedTypes, Zt = We ? We.emptyScript : "", he = j.reactiveElementPolyfillSupport, q = (i, e) => i, ie = { toAttribute(i, e) {
  switch (e) {
    case Boolean:
      i = i ? Zt : null;
      break;
  ...
  return t;
} }, we = (i, e) => !Gt(i, e), Fe = { attribute: !0, type: String, converter: ie, reflect: !1, hasChanged: we };
...
class G extends HTMLElement {
  ...
  static getPropertyDescriptor(e, t, n) {
    const { get: o, set: l } = Wt(this.prototype, e) ?? { get() {
      return this[t];
    }, set(u) {
      this[t] = u;
    } };
    return { get() {
      ...
      l.call(this, u), this.requestUpdate(e, g, n);
  ...
  static finalizeStyles(e) {
    ...
    if (Array.isArray(e)) {
      ...
      for (const o of n) t.unshift(Be(o));
  ...
  _$AK(e, t) {
    ...
    if (o !== void 0 && this._$Em !== o) {
      const u = n.getPropertyOptions(o), g = typeof u.converter == "function" ? { fromAttribute: u.converter } : ((l = u.converter) == null ? void 0 : l.fromAttribute) !== void 0 ? u.converter : ie;
      this._$Em = o, this[o] = g.fromAttribute(t, u.type), this._$Em = null;
    }
  }
  requestUpdate(e, t, n) {
    if (e !== void 0) {
...
G.elementStyles = [], G.shadowRootOptions = { mode: "open" }, G[q("elementProperties")] = /* @__PURE__ */ new Map(), G[q("finalized")] = /* @__PURE__ */ new Map(), he == null || he({ ReactiveElement: G }), (j.reactiveElementVersions ?? (j.reactiveElementVersions = [])).push("2.0.4");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Z = globalThis, se = Z.trustedTypes, Ve = se ? se.createPolicy("lit-html", { createHTML: (i) => i }) : void 0, et = "$lit$", U = `lit$${Math.random().toFixed(9).slice(2)}$`, tt = "?" + U, Xt = `<${tt}>`, D = document, Y = () => D.createComment(""), J = (i) => i === null || typeof i != "object" && typeof i != "function", ge = Array.isArray, Yt = (i) => ge(i) || typeof (i == null ? void 0 : i[Symbol.iterator]) == "function", fe = `[ 	
\f\r]`, V = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, qe = /-->/g, Ze = />/g, H = RegExp(`>|${fe}(?:([^\\s"'>=/]+)(${fe}*=${fe}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), Xe = /'/g, Ye = /"/g, rt = /^(?:script|style|textarea|title)$/i, Jt = (i) => (e, ...t) => ({ _$litType$: i, strings: e, values: t }), Qt = Jt(1), B = Symbol.for("lit-noChange"), C = Symbol.for("lit-nothing"), Je = /* @__PURE__ */ new WeakMap(), I = D.createTreeWalker(D, 129);
function nt(i, e) {
...
const Kt = (i, e) => {
  ...
  for (let g = 0; g < t; g++) {
    const v = i[g];
    let b, A, $ = -1, T = 0;
    for (; T < v.length && (u.lastIndex = T, A = u.exec(v), A !== null); ) T = u.lastIndex, u === V ? A[1] === "!--" ? u = qe : A[1] !== void 0 ? u = Ze : A[2] !== void 0 ? (rt.test(A[2]) && (o = RegExp("</" + A[2], "g")), u = H) : A[3] !== void 0 && (u = H) : u === H ? A[0] === ">" ? (u = o ?? V, $ = -1) : A[1] === void 0 ? $ = -2 : ($ = u.lastIndex - A[2].length, b = A[1], u = A[3] === void 0 ? H : A[3] === '"' ? Ye : Xe) : u === Ye || u === Xe ? u = H : u === qe || u === Ze ? u = V : (u = H, o = void 0);
    const R = u === H && i[g + 1].startsWith("/>") ? " " : "";
    l += u === V ? v + Xt : $ >= 0 ? (n.push(b), v.slice(0, $) + et + v.slice($) + U + R) : v + U + ($ === -2 ? g : R);
  }
...
class Q {
  constructor({ strings: e, _$litType$: t }, n) {
    ...
    this.parts = [];
    let l = 0, u = 0;
    const g = e.length - 1, v = this.parts, [b, A] = Kt(e, t);
    if (this.el = Q.createElement(b, n), I.currentNode = this.el.content, t === 2 || t === 3) {
      const $ = this.el.content.firstChild;
      $.replaceWith(...$.childNodes);
    }
    for (; (o = I.nextNode()) !== null && v.length < g; ) {
      if (o.nodeType === 1) {
        ...
        if (rt.test(o.tagName)) {
          ...
          if (T > 0) {
            ...
            for (let R = 0; R < T; R++) o.append($[R], Y()), I.nextNode(), v.push({ type: 2, index: ++l });
            o.append($[T], Y());
          }
        }
...
function W(i, e, t = i, n) {
  ...
  return (o == null ? void 0 : o.constructor) !== l && ((g = o == null ? void 0 : o._$AO) == null || g.call(o, !1), l === void 0 ? o = void 0 : (o = new l(i), o._$AT(i, t, n)), n !== void 0 ? (t.o ?? (t.o = []))[n] = o : t.l = o), o !== void 0 && (e = W(i, o._$AS(i, e.values), o, n)), e;
}
class er {
  constructor(e, t) {
  ...
  u(e) {
    ...
    I.currentNode = o;
    let l = I.nextNode(), u = 0, g = 0, v = n[0];
    for (; v !== void 0; ) {
      if (u === v.index) {
        let b;
        v.type === 2 ? b = new ee(l, l.nextSibling, this, e) : v.type === 1 ? b = new v.ctor(l, v.name, v.strings, this, e) : v.type === 6 && (b = new ir(l, this, e)), this._$AV.push(b), v = n[++g];
      }
      u !== (v == null ? void 0 : v.index) && (l = I.nextNode(), u++);
    }
    return I.currentNode = D, o;
  }
  p(e) {
    let t = 0;
...
class ee {
  ...
  _$AI(e, t = this) {
    e = W(this, e, t), J(e) ? e === C || e == null || e === "" ? (this._$AH !== C && this._$AR(), this._$AH = C) : e !== this._$AH && e !== B && this._(e) : e._$litType$ !== void 0 ? this.$(e) : e.nodeType !== void 0 ? this.T(e) : Yt(e) ? this.k(e) : this._(e);
  }
  O(e) {
  ...
  $(e) {
    ...
    if (((l = this._$AH) == null ? void 0 : l._$AD) === o) this._$AH.p(t);
      ...
      const u = new er(o, this), g = u.u(this.options);
...
class oe {
  ...
  _$AI(e, t = this, n, o) {
    ...
    let u = !1;
    if (l === void 0) e = W(this, e, t, 0), u = !J(e) || e !== this._$AH && e !== B, u && (this._$AH = e);
    else {
      const g = e;
      let v, b;
      for (e = l[0], v = 0; v < l.length - 1; v++) b = W(this, g[n + v], t, v), b === B && (b = this._$AH[v]), u || (u = !J(b) || b !== this._$AH[v]), b === C ? e = C : e !== C && (e += (b ?? "") + l[v + 1]), this._$AH[v] = b;
    }
    u && !o && this.j(e);
  }
  j(e) {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const or = { attribute: !0, type: String, converter: ie, reflect: !1, hasChanged: we }, ar = (i = or, e, t) => {
  ...
  if (l === void 0 && globalThis.litPropertyMetadata.set(o, l = /* @__PURE__ */ new Map()), l.set(t.name, i), n === "accessor") {
    ...
    return { set(g) {
      ...
      e.set.call(this, g), this.requestUpdate(u, v, i);
    }, init(g) {
      return g !== void 0 && this.P(u, void 0, i), g;
    } };
  }
  if (n === "setter") {
    const { name: u } = t;
    return function(g) {
      const v = this[u];
      e.call(this, g), this.requestUpdate(u, v, i);
    };
  }
...
var lr = Object.defineProperty, cr = Object.getOwnPropertyDescriptor, $e = (i, e, t, n) => {
...
let K = class extends X {
  ...
  render() {
    return Qt`<div class="node"><div class="eyebrow">Switch</div><strong>Branch</strong><div>${this.expression}</div></div>`;
  }
};
K.styles = Lt`:host{display:block}.node{padding:14px 16px;border-radius:16px;border:1px solid rgba(124,58,237,.18);background:#f5f3ff;color:#0f172a}.eyebrow{font-size:.72rem;text-transform:uppercase;letter-spacing:.12em;color:#7c3aed;font-weight:700}`;
$e([
  ur({ type: String })
], K.prototype, "expression", 2);
$e([
  It({ attributeType: ve.PROPERTY, uiComponentType: ye.TEXTAREA, displayLabel: "Expression", fieldMappings: "expression" })
], K.prototype, "expressionConfig", 1);
K = $e([
  Nt({ name: "zero-flow-node-switch", version: "1.0.0", title: "Switch Node", elementSelector: "zero-flow-node-switch", group: "Flow Nodes", iconName: "flow-switch-node.png" }),
  Ut()
], K);
export {
  K as ZeroFlowNodeSwitch
};

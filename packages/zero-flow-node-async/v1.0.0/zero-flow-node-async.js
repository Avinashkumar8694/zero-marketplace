...
(function(i) {
  (function(e) {
    ...
    }, $ = Object.getPrototypeOf(Function), T = typeof Map == "function" && typeof Map.prototype.entries == "function" ? Map : Ot(), R = typeof Set == "function" && typeof Set.prototype.entries == "function" ? Set : Pt(), N = typeof WeakMap == "function" ? WeakMap : Ct(), z = o ? Symbol.for("@reflect-metadata:registry") : void 0, re = Et(), be = St(re);
    function ot(r, s, a, c) {
      if (_(a)) {
        if (!Re(r))
          throw new TypeError();
    ...
    function At() {
      var r;
      !_(z) && typeof t.Reflect < "u" && !(z in t.Reflect) && typeof t.Reflect.defineMetadata == "function" && (r = Mt(t.Reflect));
      var s, a, c, y = new N(), P = {
        registerProvider: O,
        getProvider: h,
        setProvider: f
      ...
      function f(p, m, E) {
        ...
        if (S !== E) {
          if (!_(S))
            return !1;
          var k = y.get(p);
          _(k) && (k = new T(), y.set(p, k)), k.set(m, E);
        }
        return !0;
      }
    }
    function Et() {
      var r;
      return !_(z) && M(t.Reflect) && Object.isExtensible(t.Reflect) && (r = t.Reflect[z]), _(r) && (r = At()), !_(z) && M(t.Reflect) && Object.isExtensible(t.Reflect) && Object.defineProperty(t.Reflect, z, {
        enumerable: !1,
        configurable: !1,
        writable: !1,
        value: r
    ...
    function Mt(r) {
      var s = r.defineMetadata, a = r.hasOwnMetadata, c = r.getOwnMetadata, y = r.getOwnMetadataKeys, P = r.deleteMetadata, O = new N(), g = {
        isProviderFor: function(h, d) {
          var f = O.get(h);
          return !_(f) && f.has(d) ? !0 : y(h, d).length ? (_(f) && (f = new R(), O.set(h, f)), f.add(d), !0) : !1;
        },
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: Wt, defineProperty: Bt, getOwnPropertyDescriptor: Ft, getOwnPropertyNames: Vt, getOwnPropertySymbols: qt, getPrototypeOf: Zt } = Object, I = globalThis, Be = I.trustedTypes, Yt = Be ? Be.emptyScript : "", pe = I.reactiveElementPolyfillSupport, Z = (i, e) => i, ae = { toAttribute(i, e) {
  switch (e) {
    case Boolean:
      i = i ? Yt : null;
      break;
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Y = globalThis, ue = Y.trustedTypes, Ve = ue ? ue.createPolicy("lit-html", { createHTML: (i) => i }) : void 0, tt = "$lit$", U = `lit$${Math.random().toFixed(9).slice(2)}$`, rt = "?" + U, Xt = `<${rt}>`, D = document, J = () => D.createComment(""), Q = (i) => i === null || typeof i != "object" && typeof i != "function", $e = Array.isArray, Jt = (i) => $e(i) || typeof (i == null ? void 0 : i[Symbol.iterator]) == "function", ye = `[ 	
\f\r]`, q = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, qe = /-->/g, Ze = />/g, j = RegExp(`>|${ye}(?:([^\\s"'>=/]+)(${ye}*=${ye}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), Ye = /'/g, Xe = /"/g, nt = /^(?:script|style|textarea|title)$/i, Qt = (i) => (e, ...t) => ({ _$litType$: i, strings: e, values: t }), Kt = Qt(1), B = Symbol.for("lit-noChange"), C = Symbol.for("lit-nothing"), Je = /* @__PURE__ */ new WeakMap(), H = D.createTreeWalker(D, 129);
function it(i, e) {
...
const er = (i, e) => {
  ...
  for (let w = 0; w < t; w++) {
    const v = i[w];
    let b, A, $ = -1, T = 0;
    for (; T < v.length && (u.lastIndex = T, A = u.exec(v), A !== null); ) T = u.lastIndex, u === q ? A[1] === "!--" ? u = qe : A[1] !== void 0 ? u = Ze : A[2] !== void 0 ? (nt.test(A[2]) && (o = RegExp("</" + A[2], "g")), u = j) : A[3] !== void 0 && (u = j) : u === j ? A[0] === ">" ? (u = o ?? q, $ = -1) : A[1] === void 0 ? $ = -2 : ($ = u.lastIndex - A[2].length, b = A[1], u = A[3] === void 0 ? j : A[3] === '"' ? Xe : Ye) : u === Xe || u === Ye ? u = j : u === qe || u === Ze ? u = q : (u = j, o = void 0);
    const R = u === j && i[w + 1].startsWith("/>") ? " " : "";
    l += u === q ? v + Xt : $ >= 0 ? (n.push(b), v.slice(0, $) + tt + v.slice($) + U + R) : v + U + ($ === -2 ? w : R);
  }
  return [it(i, l + (i[t] || "<?>") + (e === 2 ? "</svg>" : e === 3 ? "</math>" : "")), n];
};
class K {
  constructor({ strings: e, _$litType$: t }, n) {
    ...
    if (this.el = K.createElement(b, n), H.currentNode = this.el.content, t === 2 || t === 3) {
    ...
    for (; (o = H.nextNode()) !== null && v.length < w; ) {
      if (o.nodeType === 1) {
        if (o.hasAttributes()) for (const $ of o.getAttributeNames()) if ($.endsWith(tt)) {
          ...
          v.push({ type: 1, index: l, name: N[2], strings: R, ctor: N[1] === "." ? rr : N[1] === "?" ? nr : N[1] === "@" ? ir : le }), o.removeAttribute($);
        ...
        if (nt.test(o.tagName)) {
          ...
          if (T > 0) {
            ...
            for (let R = 0; R < T; R++) o.append($[R], J()), H.nextNode(), v.push({ type: 2, index: ++l });
            o.append($[T], J());
          }
        }
      } else if (o.nodeType === 8) if (o.data === rt) v.push({ type: 2, index: l });
      else {
        let $ = -1;
...
function F(i, e, t = i, n) {
  ...
  return (o == null ? void 0 : o.constructor) !== l && ((w = o == null ? void 0 : o._$AO) == null || w.call(o, !1), l === void 0 ? o = void 0 : (o = new l(i), o._$AT(i, t, n)), n !== void 0 ? (t.o ?? (t.o = []))[n] = o : t.l = o), o !== void 0 && (e = F(i, o._$AS(i, e.values), o, n)), e;
}
class tr {
  constructor(e, t) {
  ...
  u(e) {
    ...
    for (; v !== void 0; ) {
      if (u === v.index) {
        let b;
        v.type === 2 ? b = new ee(l, l.nextSibling, this, e) : v.type === 1 ? b = new v.ctor(l, v.name, v.strings, this, e) : v.type === 6 && (b = new sr(l, this, e)), this._$AV.push(b), v = n[++w];
      }
...
class ee {
  ...
  _$AI(e, t = this) {
    e = F(this, e, t), Q(e) ? e === C || e == null || e === "" ? (this._$AH !== C && this._$AR(), this._$AH = C) : e !== this._$AH && e !== B && this._(e) : e._$litType$ !== void 0 ? this.$(e) : e.nodeType !== void 0 ? this.T(e) : Jt(e) ? this.k(e) : this._(e);
  }
  O(e) {
  ...
  _(e) {
    this._$AH !== C && Q(this._$AH) ? this._$AA.nextSibling.data = e : this.T(D.createTextNode(e)), this._$AH = e;
  }
  $(e) {
    var l;
  ...
  k(e) {
    ...
    const t = this._$AH;
    let n, o = 0;
    for (const l of e) o === t.length ? t.push(n = new ee(this.O(J()), this.O(J()), this, this.options)) : n = t[o], n._$AI(l), o++;
...
class le {
  ...
  _$AI(e, t = this, n, o) {
    ...
    let u = !1;
    if (l === void 0) e = F(this, e, t, 0), u = !Q(e) || e !== this._$AH && e !== B, u && (this._$AH = e);
    else {
      const w = e;
      let v, b;
      for (e = l[0], v = 0; v < l.length - 1; v++) b = F(this, w[n + v], t, v), b === B && (b = this._$AH[v]), u || (u = !Q(b) || b !== this._$AH[v]), b === C ? e = C : e !== C && (e += (b ?? "") + l[v + 1]), this._$AH[v] = b;
    }
    u && !o && this.j(e);
  }
  j(e) {
...
ve == null || ve(K, ee), (Y.litHtmlVersions ?? (Y.litHtmlVersions = [])).push("3.2.0");
const or = (i, e, t) => {
  const n = (t == null ? void 0 : t.renderBefore) ?? e;
  let o = n._$litPart$;
  if (o === void 0) {
    const l = (t == null ? void 0 : t.renderBefore) ?? null;
    n._$litPart$ = o = new ee(e.insertBefore(J(), l), l, void 0, t ?? {});
  }
  return o._$AI(i), o;
};
/**
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const ar = { attribute: !0, type: String, converter: ae, reflect: !1, hasChanged: we }, ur = (i = ar, e, t) => {
...
var lr = Object.defineProperty, cr = Object.getOwnPropertyDescriptor, te = (i, e, t, n) => {
...
let L = class extends X {
  constructor() {
    super(...arguments), this.strategy = "queue", this.delayMs = 0;
  }
  get strategyConfig() {
    return this.strategy;
  }
  set strategyConfig(i) {
    this.strategy = i || "queue";
  }
  get delayMsConfig() {
    return this.delayMs;
  }
  set delayMsConfig(i) {
    this.delayMs = Number(i || 0);
  }
  render() {
    return Kt`<div class="node"><div class="eyebrow">Async</div><strong>${this.strategy}</strong><div>${this.delayMs} ms</div></div>`;
  }
};
L.styles = zt`:host{display:block}.node{padding:14px 16px;border-radius:16px;border:1px solid rgba(8,145,178,.2);background:#ecfeff;color:#0f172a}.eyebrow{font-size:.72rem;text-transform:uppercase;letter-spacing:.12em;color:#0e7490;font-weight:700}`;
te([
  st({ type: String })
], L.prototype, "strategy", 2);
te([
  st({ type: Number })
], L.prototype, "delayMs", 2);
te([
  Ke({ attributeType: oe.PROPERTY, uiComponentType: se.DROPDOWN, displayLabel: "Strategy", fieldMappings: "strategy", optionItems: [{ label: "Queue", value: "queue" }, { label: "Debounce", value: "debounce" }, { label: "Retry", value: "retry" }, { label: "Schedule", value: "schedule" }] })
], L.prototype, "strategyConfig", 1);
te([
  Ke({ attributeType: oe.PROPERTY, uiComponentType: se.NUMBER_INPUT, displayLabel: "Delay (ms)", fieldMappings: "delayMs" })
], L.prototype, "delayMsConfig", 1);
L = te([
  It({ name: "zero-flow-node-async", version: "1.0.0", title: "Async Node", elementSelector: "zero-flow-node-async", group: "Flow Nodes", iconName: "flow-async-node.png" }),
  jt()
], L);
export {
  L as ZeroFlowNodeAsync
};

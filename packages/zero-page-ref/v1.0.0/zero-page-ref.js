 ...
 */
const N = globalThis, I = N.ShadowRoot && (N.ShadyCSS === void 0 || N.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, st = Symbol(), W = /* @__PURE__ */ new WeakMap();
let at = class {
  constructor(t, e, s) {
...
}, V = I ? (r) => r : (r) => r instanceof CSSStyleSheet ? ((t) => {
  let e = "";
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: dt, defineProperty: pt, getOwnPropertyDescriptor: ut, getOwnPropertyNames: $t, getOwnPropertySymbols: _t, getPrototypeOf: ft } = Object, f = globalThis, q = f.trustedTypes, At = q ? q.emptyScript : "", D = f.reactiveElementPolyfillSupport, w = (r, t) => r, j = { toAttribute(r, t) {
  switch (t) {
    case Boolean:
      r = r ? At : null;
      break;
...
let v = class extends HTMLElement {
  ...
  requestUpdate(t, e, s, i = !1, n) {
    ...
    if (t !== void 0) {
      ...
      if (i === !1 && (n = this[t]), s ?? (s = a.getPropertyOptions(t)), !((s.hasChanged ?? it)(n, e) || s.useDefault && s.reflect && n === ((o = this._$Ej) == null ? void 0 : o.get(t)) && !this.hasAttribute(a._$Eu(t, s)))) return;
      this.C(t, e, s);
    }
...
v.elementStyles = [], v.shadowRootOptions = { mode: "open" }, v[w("elementProperties")] = /* @__PURE__ */ new Map(), v[w("finalized")] = /* @__PURE__ */ new Map(), D == null || D({ ReactiveElement: v }), (f.reactiveElementVersions ?? (f.reactiveElementVersions = [])).push("2.1.2");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const C = globalThis, J = (r) => r, R = C.trustedTypes, K = R ? R.createPolicy("lit-html", { createHTML: (r) => r }) : void 0, rt = "$lit$", _ = `lit$${Math.random().toFixed(9).slice(2)}$`, nt = "?" + _, mt = `<${nt}>`, y = document, x = () => y.createComment(""), U = (r) => r === null || typeof r != "object" && typeof r != "function", B = Array.isArray, gt = (r) => B(r) || typeof (r == null ? void 0 : r[Symbol.iterator]) == "function", k = `[ 	
\f\r]`, b = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, F = /-->/g, G = />/g, A = RegExp(`>|${k}(?:([^\\s"'>=/]+)(${k}*=${k}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), Q = /'/g, X = /"/g, ot = /^(?:script|style|textarea|title)$/i, E = Symbol.for("lit-noChange"), d = Symbol.for("lit-nothing"), Y = /* @__PURE__ */ new WeakMap(), m = y.createTreeWalker(y, 129);
function ht(r, t) {
...
const yt = (r, t) => {
  ...
  for (let a = 0; a < e; a++) {
    const h = r[a];
    let c, p, l = -1, u = 0;
    for (; u < h.length && (o.lastIndex = u, p = o.exec(h), p !== null); ) u = o.lastIndex, o === b ? p[1] === "!--" ? o = F : p[1] !== void 0 ? o = G : p[2] !== void 0 ? (ot.test(p[2]) && (i = RegExp("</" + p[2], "g")), o = A) : p[3] !== void 0 && (o = A) : o === A ? p[0] === ">" ? (o = i ?? b, l = -1) : p[1] === void 0 ? l = -2 : (l = o.lastIndex - p[2].length, c = p[1], o = p[3] === void 0 ? A : p[3] === '"' ? X : Q) : o === X || o === Q ? o = A : o === F || o === G ? o = b : (o = A, i = void 0);
    const $ = o === A && r[a + 1].startsWith("/>") ? " " : "";
    n += o === b ? h + mt : l >= 0 ? (s.push(c), h.slice(0, l) + rt + h.slice(l) + _ + $) : h + _ + (l === -2 ? a : $);
  }
    ...
    for (; (i = m.nextNode()) !== null && h.length < a; ) {
      if (i.nodeType === 1) {
        if (i.hasAttributes()) for (const l of i.getAttributeNames()) if (l.endsWith(rt)) {
          ...
          h.push({ type: 1, index: n, name: M[2], strings: $, ctor: M[1] === "." ? Et : M[1] === "?" ? St : M[1] === "@" ? bt : T }), i.removeAttribute(l);
...
class vt {
  ...
  u(t) {
    ...
    for (; h !== void 0; ) {
      if (o === h.index) {
        let c;
        h.type === 2 ? c = new H(n, n.nextSibling, this, t) : h.type === 1 ? c = new h.ctor(n, h.name, h.strings, this, t) : h.type === 6 && (c = new wt(n, this, t)), this._$AV.push(c), h = s[++a];
      }
...
z == null || z(O, H), (C.litHtmlVersions ?? (C.litHtmlVersions = [])).push("3.3.3");
const Ct = (r, t, e) => {
...
var et;
P._$litElement$ = !0, P.finalized = !0, (et = g.litElementHydrateSupport) == null || et.call(g, { LitElement: P });
const L = g.litElementPolyfillSupport;
...
var xt = Object.getOwnPropertyDescriptor, Ut = (r, t, e, s) => {

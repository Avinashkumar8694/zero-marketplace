...
var Le = (i, e, t) => xt(i, typeof e != "symbol" ? e + "" : e, t);
...
(function(i) {
  (function(e) {
    ...
    }, w = Object.getPrototypeOf(Function), R = typeof Map == "function" && typeof Map.prototype.entries == "function" ? Map : Ot(), T = typeof Set == "function" && typeof Set.prototype.entries == "function" ? Set : Pt(), N = typeof WeakMap == "function" ? WeakMap : Ct(), z = s ? Symbol.for("@reflect-metadata:registry") : void 0, re = Et(), Ae = St(re);
    function ot(n, o, a, c) {
      if (m(a)) {
        if (!ke(n))
          throw new TypeError();
        ...
        if (!M(c) && !m(c) && !G(c))
          throw new TypeError();
        return G(c) && (c = void 0), a = x(a), _t(n, o, a, c);
      }
    }
    e("decorate", ot);
    function at(n, o) {
    ...
    function ue(n, o, a) {
      ...
      return m(c) ? !1 : Te(c.OrdinaryHasOwnMetadata(n, o, a));
    }
    function Se(n, o, a) {
      var c = ue(n, o, a);
      if (c)
    ...
    function Pe(n, o) {
      ...
      if (a.length <= 0)
        return v;
      for (var P = new T(), O = [], $ = 0, h = a; $ < h.length; $++) {
        var d = h[$], f = P.has(d);
        f || (P.add(d), O.push(d));
      }
      ...
      function f(p, g, E) {
        ...
        if (S !== E) {
          if (!m(S))
            return !1;
          var k = v.get(p);
          m(k) && (k = new R(), v.set(p, k)), k.set(g, E);
        }
        return !0;
      }
    }
    ...
    function St(n) {
      ...
      function c(d, f, p) {
        ...
        if (m(g)) {
          if (!p)
            return;
          g = new R(), o.set(d, g), E = !0;
        }
        var S = g.get(f);
        if (m(S)) {
          if (!p)
            return;
          if (S = new R(), g.set(f, S), !n.setProvider(d, f, a))
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: Bt, defineProperty: Vt, getOwnPropertyDescriptor: Ft, getOwnPropertyNames: qt, getOwnPropertySymbols: Zt, getPrototypeOf: Xt } = Object, I = globalThis, Ve = I.trustedTypes, Yt = Ve ? Ve.emptyScript : "", de = I.reactiveElementPolyfillSupport, Z = (i, e) => i, se = { toAttribute(i, e) {
  switch (e) {
    case Boolean:
      i = i ? Yt : null;
      break;
...
W.elementStyles = [], W.shadowRootOptions = { mode: "open" }, W[Z("elementProperties")] = /* @__PURE__ */ new Map(), W[Z("finalized")] = /* @__PURE__ */ new Map(), de == null || de({ ReactiveElement: W }), (I.reactiveElementVersions ?? (I.reactiveElementVersions = [])).push("2.1.2");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const X = globalThis, qe = (i) => i, oe = X.trustedTypes, Ze = oe ? oe.createPolicy("lit-html", { createHTML: (i) => i }) : void 0, rt = "$lit$", U = `lit$${Math.random().toFixed(9).slice(2)}$`, nt = "?" + U, Jt = `<${nt}>`, L = document, J = () => L.createComment(""), Q = (i) => i === null || typeof i != "object" && typeof i != "function", we = Array.isArray, Qt = (i) => we(i) || typeof (i == null ? void 0 : i[Symbol.iterator]) == "function", fe = `[ 	
\f\r]`, q = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, Xe = /-->/g, Ye = />/g, j = RegExp(`>|${fe}(?:([^\\s"'>=/]+)(${fe}*=${fe}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), Je = /'/g, Qe = /"/g, it = /^(?:script|style|textarea|title)$/i, Kt = (i) => (e, ...t) => ({ _$litType$: i, strings: e, values: t }), er = Kt(1), B = Symbol.for("lit-noChange"), C = Symbol.for("lit-nothing"), Ke = /* @__PURE__ */ new WeakMap(), D = L.createTreeWalker(L, 129);
function st(i, e) {
...
const tr = (i, e) => {
  ...
  for (let _ = 0; _ < t; _++) {
    const y = i[_];
    let A, b, w = -1, R = 0;
    for (; R < y.length && (l.lastIndex = R, b = l.exec(y), b !== null); ) R = l.lastIndex, l === q ? b[1] === "!--" ? l = Xe : b[1] !== void 0 ? l = Ye : b[2] !== void 0 ? (it.test(b[2]) && (s = RegExp("</" + b[2], "g")), l = j) : b[3] !== void 0 && (l = j) : l === j ? b[0] === ">" ? (l = s ?? q, w = -1) : b[1] === void 0 ? w = -2 : (w = l.lastIndex - b[2].length, A = b[1], l = b[3] === void 0 ? j : b[3] === '"' ? Qe : Je) : l === Qe || l === Je ? l = j : l === Xe || l === Ye ? l = q : (l = j, s = void 0);
    const T = l === j && i[_ + 1].startsWith("/>") ? " " : "";
    u += l === q ? y + Jt : w >= 0 ? (r.push(A), y.slice(0, w) + rt + y.slice(w) + U + T) : y + U + (w === -2 ? _ : T);
  }
...
class K {
  constructor({ strings: e, _$litType$: t }, r) {
    ...
    if (this.el = K.createElement(A, r), D.currentNode = this.el.content, t === 2 || t === 3) {
    ...
    for (; (s = D.nextNode()) !== null && y.length < _; ) {
      if (s.nodeType === 1) {
        if (s.hasAttributes()) for (const w of s.getAttributeNames()) if (w.endsWith(rt)) {
          ...
          y.push({ type: 1, index: u, name: N[2], strings: T, ctor: N[1] === "." ? nr : N[1] === "?" ? ir : N[1] === "@" ? sr : ae }), s.removeAttribute(w);
        ...
        if (it.test(s.tagName)) {
          ...
          if (R > 0) {
            ...
            for (let T = 0; T < R; T++) s.append(w[T], J()), D.nextNode(), y.push({ type: 2, index: ++u });
            s.append(w[R], J());
          }
        }
...
var hr = Object.defineProperty, dr = Object.getOwnPropertyDescriptor, be = (i, e, t, r) => {
...
let ee = class extends Y {
  ...
  render() {
    return er`<div class="node"><div class="eyebrow">Listen</div><strong>${this.channel}</strong></div>`;
  }
};
ee.styles = Gt`:host{display:block}.node{padding:14px 16px;border-radius:16px;border:1px solid rgba(79,70,229,.18);background:#eef2ff;color:#0f172a}.eyebrow{font-size:.72rem;text-transform:uppercase;letter-spacing:.12em;color:#4f46e5;font-weight:700}`;
be([
  cr({ type: String })
], ee.prototype, "channel", 2);
be([
  Lt({ attributeType: _e.PROPERTY, uiComponentType: ve.TEXT_INPUT, displayLabel: "Channel", fieldMappings: "channel" })
], ee.prototype, "channelConfig", 1);
ee = be([
  It({ name: "zero-flow-node-listen", version: "1.0.0", title: "Listen Node", elementSelector: "zero-flow-node-listen", group: "Flow Nodes", iconName: "flow-listen-node.png" }),
  jt()
], ee);
export {
  ee as ZeroFlowNodeListen
};

  ...
  (function(e) {
    ...
    function it(r, s, a, c) {
      if (_(a)) {
        ...
        if (!M(c) && !_(c) && !z(c))
          throw new TypeError();
        return z(c) && (c = void 0), a = x(a), yt(r, s, a, c);
      }
    }
    e("decorate", it);
    function st(r, s) {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: Gt, defineProperty: Wt, getOwnPropertyDescriptor: Bt, getOwnPropertyNames: Vt, getOwnPropertySymbols: Ft, getPrototypeOf: qt } = Object, j = globalThis, Be = j.trustedTypes, Zt = Be ? Be.emptyScript : "", he = j.reactiveElementPolyfillSupport, q = (i, e) => i, ie = { toAttribute(i, e) {
  switch (e) {
    case Boolean:
      i = i ? Zt : null;
      break;
  ...
  return t;
} }, ge = (i, e) => !Gt(i, e), Ve = { attribute: !0, type: String, converter: ie, reflect: !1, hasChanged: ge };
...
class G extends HTMLElement {
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(q("properties"))) {
      const t = this.properties, n = [...Vt(t), ...Ft(t)];
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Z = globalThis, se = Z.trustedTypes, Fe = se ? se.createPolicy("lit-html", { createHTML: (i) => i }) : void 0, et = "$lit$", U = `lit$${Math.random().toFixed(9).slice(2)}$`, tt = "?" + U, Xt = `<${tt}>`, D = document, Y = () => D.createComment(""), J = (i) => i === null || typeof i != "object" && typeof i != "function", we = Array.isArray, Yt = (i) => we(i) || typeof (i == null ? void 0 : i[Symbol.iterator]) == "function", fe = `[ 	
\f\r]`, F = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, qe = /-->/g, Ze = />/g, H = RegExp(`>|${fe}(?:([^\\s"'>=/]+)(${fe}*=${fe}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), Xe = /'/g, Ye = /"/g, rt = /^(?:script|style|textarea|title)$/i, Jt = (i) => (e, ...t) => ({ _$litType$: i, strings: e, values: t }), Qt = Jt(1), W = Symbol.for("lit-noChange"), C = Symbol.for("lit-nothing"), Je = /* @__PURE__ */ new WeakMap(), I = D.createTreeWalker(D, 129);
function nt(i, e) {
...
const Kt = (i, e) => {
  ...
  let o, l = e === 2 ? "<svg>" : e === 3 ? "<math>" : "", u = F;
  for (let w = 0; w < t; w++) {
    const v = i[w];
    let b, A, $ = -1, T = 0;
    for (; T < v.length && (u.lastIndex = T, A = u.exec(v), A !== null); ) T = u.lastIndex, u === F ? A[1] === "!--" ? u = qe : A[1] !== void 0 ? u = Ze : A[2] !== void 0 ? (rt.test(A[2]) && (o = RegExp("</" + A[2], "g")), u = H) : A[3] !== void 0 && (u = H) : u === H ? A[0] === ">" ? (u = o ?? F, $ = -1) : A[1] === void 0 ? $ = -2 : ($ = u.lastIndex - A[2].length, b = A[1], u = A[3] === void 0 ? H : A[3] === '"' ? Ye : Xe) : u === Ye || u === Xe ? u = H : u === qe || u === Ze ? u = F : (u = H, o = void 0);
    const R = u === H && i[w + 1].startsWith("/>") ? " " : "";
    l += u === F ? v + Xt : $ >= 0 ? (n.push(b), v.slice(0, $) + et + v.slice($) + U + R) : v + U + ($ === -2 ? w : R);
  }
...
class Q {
  constructor({ strings: e, _$litType$: t }, n) {
    ...
    for (; (o = I.nextNode()) !== null && v.length < w; ) {
      if (o.nodeType === 1) {
...
class er {
  ...
  u(e) {
    ...
    I.currentNode = o;
    let l = I.nextNode(), u = 0, w = 0, v = n[0];
    for (; v !== void 0; ) {
      if (u === v.index) {
        let b;
...
let K = class extends X {
  constructor() {
    super(...arguments), this.value = "result";
  }
  get valueConfig() {
    return this.value;
  }
  ...
  render() {
    return Qt`<div class="node"><div class="eyebrow">Return</div><strong>${this.value}</strong></div>`;
  }
};
K.styles = Lt`:host{display:block}.node{padding:14px 16px;border-radius:16px;border:1px solid rgba(220,38,38,.18);background:#fef2f2;color:#0f172a}.eyebrow{font-size:.72rem;text-transform:uppercase;letter-spacing:.12em;color:#dc2626;font-weight:700}`;
$e([
  ur({ type: String })
], K.prototype, "value", 2);
$e([
  It({ attributeType: ve.PROPERTY, uiComponentType: ye.TEXTAREA, displayLabel: "Return Value", fieldMappings: "value" })
], K.prototype, "valueConfig", 1);
K = $e([
  Nt({ name: "zero-flow-node-return", version: "1.0.0", title: "Return Node", elementSelector: "zero-flow-node-return", group: "Flow Nodes", iconName: "flow-return-node.png" }),
  Ut()
], K);
export {
  K as ZeroFlowNodeReturn
};

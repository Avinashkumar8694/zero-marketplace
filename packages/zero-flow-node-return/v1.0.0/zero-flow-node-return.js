...
}, Ve = me ? (i) => i : (i) => i instanceof CSSStyleSheet ? ((e) => {
  let t = "";
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: Vt, defineProperty: Bt, getOwnPropertyDescriptor: Ft, getOwnPropertyNames: qt, getOwnPropertySymbols: Zt, getPrototypeOf: Xt } = Object, j = globalThis, Be = j.trustedTypes, Yt = Be ? Be.emptyScript : "", fe = j.reactiveElementPolyfillSupport, Z = (i, e) => i, se = { toAttribute(i, e) {
  switch (e) {
    case Boolean:
      i = i ? Yt : null;
      break;
  ...
  return t;
} }, ge = (i, e) => !Vt(i, e), Fe = { attribute: !0, type: String, converter: se, reflect: !1, useDefault: !1, hasChanged: ge };
...
function B(i, e, t = i, r) {
  var l, _;
  if (e === V) return e;
  let s = r !== void 0 ? (l = t._$Co) == null ? void 0 : l[r] : t._$Cl;
  const u = Q(e) ? void 0 : e._$litDirective$;
  return (s == null ? void 0 : s.constructor) !== u && ((_ = s == null ? void 0 : s._$AO) == null || _.call(s, !1), u === void 0 ? s = void 0 : (s = new u(i), s._$AT(i, t, r)), r !== void 0 ? (t._$Co ?? (t._$Co = []))[r] = s : t._$Cl = s), s !== void 0 && (e = B(i, s._$AS(i, e.values), s, r)), e;
}
class rr {
  constructor(e, t) {
...
class te {
  ...
  _$AI(e, t = this) {
    e = B(this, e, t), Q(e) ? e === C || e == null || e === "" ? (this._$AH !== C && this._$AR(), this._$AH = C) : e !== this._$AH && e !== V && this._(e) : e._$litType$ !== void 0 ? this.$(e) : e.nodeType !== void 0 ? this.T(e) : Qt(e) ? this.k(e) : this._(e);
  }
  O(e) {
...
class ae {
  ...
  _$AI(e, t = this, r, s) {
    ...
    let l = !1;
    if (u === void 0) e = B(this, e, t, 0), l = !Q(e) || e !== this._$AH && e !== V, l && (this._$AH = e);
    else {
      const _ = e;
      let y, A;
      for (e = u[0], y = 0; y < u.length - 1; y++) A = B(this, _[r + y], t, y), A === V && (A = this._$AH[y]), l || (l = !Q(A) || A !== this._$AH[y]), A === C ? e = C : e !== C && (e += (A ?? "") + u[y + 1]), this._$AH[y] = A;
    }
    l && !s && this.j(e);
  }
  j(e) {
...
let ee = class extends Y {
  ...
  render() {
    return er`<div class="node"><div class="eyebrow">Return</div><strong>${this.value}</strong></div>`;
  }
};
ee.styles = Gt`:host{display:block}.node{padding:14px 16px;border-radius:16px;border:1px solid rgba(220,38,38,.18);background:#fef2f2;color:#0f172a}.eyebrow{font-size:.72rem;text-transform:uppercase;letter-spacing:.12em;color:#dc2626;font-weight:700}`;
be([
  cr({ type: String })
], ee.prototype, "value", 2);
be([
  Lt({ attributeType: _e.PROPERTY, uiComponentType: ve.TEXTAREA, displayLabel: "Return Value", fieldMappings: "value" })
], ee.prototype, "valueConfig", 1);
ee = be([
  jt({ name: "zero-flow-node-return", version: "1.0.0", title: "Return Node", elementSelector: "zero-flow-node-return", group: "Flow Nodes", iconName: "flow-return-node.png" }),
  Dt()
], ee);
export {
  ee as ZeroFlowNodeReturn
};
